...
The data is no in a grouped_df, not the same as the data.frame we originally saw. The grouped_df is essentially a list where each item in the list is its own dataframe which only contains the rows that correspond to a particular value of continent.
